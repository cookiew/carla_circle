...
"""extract waypoint from carla map"""
...
def main():
    ...
    try:
        ...
        # -----------------------------------
        # plot topology map and waypoints
        # -----------------------------------
        ...
        for first_pt, second_pt in waypoints:
            ...
            if np.linalg.norm(pt1) < 80 and np.linalg.norm(pt2) < 80:
                ...
                ax.plot([first_pt.transform.location.x, second_pt.transform.location.x], \
                    [-first_pt.transform.location.y, -second_pt.transform.location.y], "black")
        ...
        for path in path_list:
            ...
            # ax.plot(location_path_array[:,0], -location_path_array[:,1])
